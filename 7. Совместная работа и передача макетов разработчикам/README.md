...
Аннотация: проект учит передавать дизайн в разработку. Ты разберешь принципы Agile, Scrum и Kanban, подготовишь макеты к передаче в разработку через Figma Inspect, научишься как оформлять документацию и UI-гайдлайны, а также выстраивать коммуникацию с разработчиками. В практической части ты поучаствуешь в имитации встречи «3 Амиго». 
...
**ДОБАВИТЬ ПРО РЕЗЮМИРОВАНИЕ ВСТРЕЧИ**
...
- Оформи страницу документации в Figma или Notion/**АЛЬТЕРНАТИВА БЕЗ ВПН.**
