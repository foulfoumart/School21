...
## Chapter III
Цель практики — научиться создавать интерактивные прототипы и проводить тестирование, собирая реальные данные от пользователей.
...
– Возьми свои экраны из предыдущих модулей.
- Свяжи их в Figma с помощью интерактивных переходов.
- Настрой простые анимации (переходы, hover, click).

После полнения задания ты получишь интерактивный lo-fi или hi-fi прототип в Figma.
...
- Сделай сводный отчёт в виде таблицы или mind-map в Miro.
...
Maze / Useberry (автоматический сбор метрик).
