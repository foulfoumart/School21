...
При работе с модулем ты получишь базовое понимание профессии UX/UI-дизайнера: чем он занимается, как связаны UX и UI, какие инструменты нужны (Figma, Miro, Trello) и как использовать AI для ускорения работы. Модуль формирует системное представление о дизайне как о процессе взаимодействия пользователя с продуктом.
...
Чтобы пройти по этому циклу, нужны рабочие инструменты. Давайте разберёмся, какие из них используются чаще всего
...
На практике ты систематизируешь элементы интерфейса, ознакомишься с таким понятием, как связи атомов → молекул → шаблонов (atomic design). 
...
Цель задания - познакомиться с современными AI-инструментами и научиться использовать их для генерации иллюстраций, текстов и прототипов.
