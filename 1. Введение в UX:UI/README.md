...
Исторически профессия выросла из веб-дизайна, но сегодня это самостоятельная роль в продуктовой команде: дизайнер исследует потребности пользователей, проектирует сценарии, создаёт прототипы и работает вместе с разработчиками и продакт-менеджерами.
