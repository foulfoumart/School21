...
В завершении давай прокачаем навыки UI-дизайна на более крупной задаче и научиться проектировать целостный экран, а не только отдельные компоненты. (УКАЗАТЬ НЕ БРАТЬ СИЛЬНО СЛОЖНЫЙ ПО СТИЛЮ ПРОЕКТ)
