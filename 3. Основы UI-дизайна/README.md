...
3. [Chapter III](#chapter-iii) \
   3.1. [Задание 1: Подборка референсов](#задание-1.-название)  
   
   3.2. [Задание 2: Создание компонентов](#задание-2.-название)   
   
   3.3. [Задание 3: Создание UI-kit](#задание-3.-название)
...
В завершении давай прокачаем навыки UI-дизайна на более крупной задаче и научиться проектировать целостный экран, а не только отдельные компоненты. Сделай лендинг в стиле минимализма без лишних эффектов и сложного UI
