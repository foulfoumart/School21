...
### Уровень 4*. Продвинутый челлендж: дизайн-тема и адаптация
Твоя цель в этом задании научиться мыслить системно и проверять UI-решения на разных сценариях использования.

- Создай две цветовые темы для приложения:
- светлая (Light theme)
- тёмная (Dark theme)
- Проверь каждую тему на доступность: контраст текста, читаемость кнопок и иконок.
...
### Уровень 5*. Создание лендинга
Цель: закрепить навыки UI-дизайна на более крупной задаче и научиться проектировать целостный экран, а не только отдельные компоненты.
