...
Карта пути пользователя показывает весь процесс взаимодействия с продуктом: шаги, эмоции, боли и точки контакта. Это как «путешествие» по сервису глазами клиента.

Но одной карты мало — нужно знать, кто именно идёт этим путём..
...
Цель: проверить, как AI помогает строить карту пути пользователя.
...
Цель: синтезировать данные в собирательный образ.
